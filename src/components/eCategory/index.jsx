...
import CreateECategory from "./CreateECategory";
import DeleteECategory from "./DeleteECategory";
...
const ECategoryList = () => {
  ...
  return (
    <>
      {/* add modal */}
      <CreateECategory getCategories={getCategories} />
                          ...
                          <tr key={item.id + index}>
                            ...
                            <td>
                              <ActionButton>
                                <ActionButtonMenu
                                  menuName={"Edit"}
                                  menuTarget={"#editECategory" + item.id}
                                />
                                <ActionButtonMenu
                                  menuName={"Delete"}
                                  menuTarget={"#deleteECategory" + item.id}
                                />
                              </ActionButton>
                            </td>
                            <EditECategory
