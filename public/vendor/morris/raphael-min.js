  ...
  (function () {
    ...
    (k.getElementByPoint = function (a, b) {
      ...
      (cl.glow = function (a) {
        ...
        a = a || {};
        var b = {
            width: (a.width || 10) + (+this.attr("strokeWidth") || 1),
            fill: a.fill || !1,
        ...
        for (var g = 1; g < c + 1; g++)
          e.push(
            d.path(f).attr({
              ...
              strokeLinecap: "round",
              strokeWidth: +((b.width / c) * g).toFixed(3),
    ...
    (function (a) {
      ...
      var q = function (d, e) {
          ...
          if (d.type == "path") {
            ...
            if (r != "none") {
              ...
              a._g.doc.getElementById(A)
                ? p[A]++
                : (h.defs.appendChild(
                    q(q("path"), { strokeLinecap: "round", d: o[r], id: A })
                  ),
                  (p[A] = 1));
                ...
                : ((C = q(q("marker"), {
                  ...
                  (D = q(q("use"), {
                    ...
                    transform:
                      ...
                      y / z +
                      ")",
                    strokeWidth: (1 / ((x / z + y / z) / 2)).toFixed(4),
                  })),
                  C.appendChild(D),
        ...
        v = function (a, b, d) {
          b = u[c(b).toLowerCase()];
          if (b) {
            var e = a.attrs["strokeWidth"] || "1",
              f =
                { round: e, square: e, butt: 0 }[
                  a.attrs["strokeLinecap"] || d["strokeLinecap"]
                ] || 0,
              g = [],
              h = b.length;
      ...
      (z.prototype = A),
        ...
        (A.transform = function (c) {
          ...
          if (d.sx != 1 || d.sy != 1) {
            var e = this.attrs[b]("strokeWidth")
              ? this.attrs["strokeWidth"]
              : 1;
            this.attr({ strokeWidth: e });
          }
          return this;
        }),
        (A.hide = function () {
        ...
        (a._engine.setViewBox = function (a, b, c, d, e) {
          ...
          while (f && h)
            (l = "strokeWidth" in h.attrs ? h.attrs["strokeWidth"] : 1),
              h.attr({ strokeWidth: l }),
              (h._.dirty = 1),
              (h._.dirtyT = 1),
              (h = h.prev);
      ...
      var A = function (a, b, d) {
        ...
        B = function (e, i) {
          ...
          if (
            ...
            i["strokeLinejoin"] != null ||
            i["strokeLinecap"] != null
          ) {
            ...
            Q.on && i.stroke && (Q.color = U.hex),
              (P =
                ...
                ((+m.opacity + 1 || 2) - 1) *
                ((+U.o + 1 || 2) - 1));
            var V = (d(i["strokeWidth"]) || 1) * 0.75;
            (P = h(g(P, 0), 1)),
              i["strokeWidth"] == null && (V = m["strokeWidth"]),
              i["strokeWidth"] && (Q.weight = V),
              V && V < 1 && (P *= V) && (Q.weight = 1),
              (Q.opacity = P),
              i["strokeLinejoin"] &&
                (Q.joinstyle = i["strokeLinejoin"] || "miter"),
              (Q.miterlimit = i["stroke-miterlimit"] || 8),
              i["strokeLinecap"] &&
                (Q.endcap =
                  i["strokeLinecap"] == "butt"
                    ? "flat"
                    : i["strokeLinecap"] == "square"
                    ? "square"
                    : "round");
