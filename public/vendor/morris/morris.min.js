      ...
      return (
        ...
        (d.prototype.drawGoal = function (a, b) {
          return this.raphael
            ...
            .attr("stroke", b)
            .attr("strokeWidth", this.options.goalStrokeWidth);
        }),
        (d.prototype.drawEvent = function (a, b) {
          return this.raphael
            .path("M" + this.transX(a) + "," + this.bottom + "V" + this.top)
            .attr("stroke", b)
            .attr("strokeWidth", this.options.eventStrokeWidth);
        }),
        ...
        (d.prototype.drawGridLine = function (a) {
          return this.raphael
            ...
            .attr("strokeWidth", this.options.gridStrokeWidth);
        }),
      ...
      return (
        ...
        (c.prototype.drawLinePath = function (a, b, c) {
          return this.raphael
            .path(a)
            .attr("stroke", b)
            .attr("strokeWidth", this.lineWidthForSeries(c));
        }),
        (c.prototype.drawLinePoint = function (a, b, c, d) {
          return this.raphael
            .circle(a, b, this.pointSizeForSeries(d))
            .attr("fill", c)
            .attr("strokeWidth", this.pointStrokeWidthForSeries(d))
    ...
    (b.DonutSegment = (function (a) {
      ...
      return (
        ...
        (b.prototype.drawDonutArc = function (a, b) {
          return this.raphael
            .path(a)
            .attr({ stroke: b, strokeWidth: 2, opacity: 0 });
        }),
        (b.prototype.drawDonutSegment = function (a, b, c, d, e) {
          return this.raphael
            .path(a)
            .attr({ fill: b, stroke: c, strokeWidth: 3 })
            .hover(d)
            .click(e);
        }),
