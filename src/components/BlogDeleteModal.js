...
const BlogDeleteModal = ({ blogsection_id, get_data }) => {
  //delete data
  async function blogDelete(id) {
    ...
    let blur_bg = document.getElementById("blogDeleteModal" + id);
    blur_bg.click();
  }
  return (
    <>
      <div className="modal fade" id={"blogDeleteModal" + blogsection_id}>
              ...
              <form>
                ...
                <div className="form-group">
                  <button
                    ...
                    onClick={() => blogDelete(blogsection_id)}
                  >
                    Delete
                  </button>
                </div>
