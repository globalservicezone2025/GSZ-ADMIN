              ...
              value: function (t, e, i) {
                ...
                if ("square" === i.shape) {
                  ...
                  o.attr({
                    ...
                    strokeWidth: i.pWidth ? i.pWidth : 0,
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              return Date.parse(
                t
                  .replace(/-/g, "https://sego.dexignzone.com/")
                  .replace(/[a-z]+/gi, " ")
              );
            },
          },
              ...
              if (t.config.xaxis.crosshairs.show) {
                ...
                1 === t.config.xaxis.crosshairs.width && (w = e.drawLine()),
                  w.attr({
                    ...
                    strokeWidth: t.config.xaxis.crosshairs.stroke.width,
                    "stroke-dasharray":
              ...
              if (this.dragged || null !== h.globals.selection) {
                ...
                h.globals.zoomEnabled &&
                  ...
                  c.attr({
                    ...
                    strokeWidth: h.config.chart.zoom.zoomedArea.stroke.width,
                    "stroke-opacity":
                  ...
                  h.globals.selectionEnabled &&
                    (d.attr({
                      ...
                      strokeWidth: h.config.chart.selection.stroke.width,
                      "stroke-dasharray":
              ...
              l.globals.dataChanged &&
                ...
                0 !== r.dur
                  ? t
                      ...
                      .afterAll(function () {
                        ("pie" !== o.chartType &&
                          ...
                          ).attr({ strokeWidth: o.strokeWidth }),
                  ...
                  : ((n = o.getPiePath({
                    ...
                    t.node.setAttribute("data:pathOrig", n),
                    t.attr({ d: n, strokeWidth: o.strokeWidth }));
            },
          },
          {
            key: "pieClicked",
